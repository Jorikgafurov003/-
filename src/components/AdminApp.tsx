  ...
  return (
    <div className="min-h-screen bg-[#f2f4f7] flex flex-col font-sans">
      ...
      <nav className="fixed bottom-0 left-0 right-0 bg-white border-t border-[#e2e5eb] px-2 py-3 flex justify-around items-center z-40 shadow-[0_-4px_20px_rgba(0,0,0,0.05)]">
        {[
          { id: 'dashboard', img: 'https://picsum.photos/seed/dash/100/100', label: t('dashboard'), color: 'bg-blue-500' },
          { id: 'products', img: 'https://picsum.photos/seed/food/100/100', label: t('products'), color: 'bg-orange-500' },
          { id: 'orders', img: 'https://picsum.photos/seed/order/100/100', label: t('orders'), color: 'bg-green-500' },
          { id: 'ai', img: 'https://picsum.photos/seed/ai/100/100', label: 'AI', color: 'bg-purple-500' },
          { id: 'banners', img: 'https://picsum.photos/seed/banner/100/100', label: t('banners'), color: 'bg-pink-500' },
          { id: 'debts', img: 'https://picsum.photos/seed/debt/100/100', label: t('debts'), color: 'bg-red-500' },
          { id: 'tracker', img: 'https://picsum.photos/seed/map/100/100', label: t('tracker'), color: 'bg-indigo-500' },
          { id: 'users', img: 'https://picsum.photos/seed/users/100/100', label: t('users'), color: 'bg-teal-500' },
          { id: 'settings', img: 'https://picsum.photos/seed/settings/100/100', label: t('settings'), color: 'bg-stone-500' },
        ].map(item => (
          <button
            key={item.id}
